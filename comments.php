 ...
 */
 ...
 // Создаем свою функцию вывода каждого коммента
   function universal_theme_comment( $comment, $args, $depth ) {
      ...
      if ( 'div' === $args['style'] ) {
         // если style - div, то тег будет div
         $tag       = 'div';
         $add_below = 'comment';
      } else {
   ...
   <div id="comments" class="comments-area">
      ...
      if ( have_comments() ) :
         ...
         <div class="comments-header">
            ...
            <a href="#add-comment" class="comments-add-button">
         ...
         ?>
         <div class="comment-add-comment--hidden-area" id="add-comment"></div>
         <?php
